...
8. Do not treat ndrstnd findings as merge criticism or modify the branch from its workspace. For critique and change requests, ask the agent that produced the analysis to review the implementation for correctness, risks, and regressions using the artifact's evidence.
